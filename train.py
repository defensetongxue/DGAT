...
parser.add_argument('--nhead', type=int, default=[1,1,1],nargs='+', help='strength')
...
def train(datastr, splitstr):
    ...
    features,adj,adj_i= padding_job(features,adj,adj_i)

    model = DGAT(nfeat=features.shape[1],
                nhidden=args.hidden,
